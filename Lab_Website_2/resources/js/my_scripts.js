...
function loadStatsPage()
{
	...
	{
		as = table.rows[rowCount].cells[ac].innerHTML;
		hs = table.rows[rowCount].cells[hc].innerHTML;
		
		if (parseInt(hs) > parseInt(as)) 
		{
			table.rows[rowCount].cells[4].innerHTML = 'Boulder';
			Wins++;
		}
		...
		{
			table.rows[rowCount].cells[4].innerHTML = "Tie";
		}
	}
...
function loadPlayersPage()
{
	...
	{
		playpos += "<a class = 'dropdown-item' href='#' onclick='switchPlayers(" +i+")'>" + players[i].name + "</a>";
	}
	
	document.getElementById("player_selector").innerHTML = playpos;
}
